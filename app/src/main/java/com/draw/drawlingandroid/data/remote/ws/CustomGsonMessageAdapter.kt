...
import com.draw.drawlingandroid.util.Constants.TYPE_DISCONNECT_REQUEST
...
import com.draw.drawlingandroid.util.Constants.TYPE_PING
...
class CustomGsonMessageAdapter<T> private constructor(
    ...
    class Factory(
        ...
        override fun create(type: Type, annotations: Array<Annotation>): MessageAdapter<*> =
            CustomGsonMessageAdapter<Any>(gson)
    }
}
